...
$_mod.main("/app$1.0.0/components/5testInput", "index.marko");
...
$_mod.def("/app$1.0.0/components/5testInput/component", function(require, exports, module, __filename, __dirname) { module.exports = class {
    onCreate(input,out) {
        console.log('input-->',input);
        this.state = {
            // value: null,
            value: 'not used input'
        }
    }
    onMount() {
        this.setState({ value: 'not used input' });
    }
    onUpdate() {
...
$_mod.def("/app$1.0.0/components/5testInput/index.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.18.24 - DO NOT EDIT
"use strict";
...
var marko_template = module.exports = require('/marko$4.18.24/src/vdom'/*"marko/src/vdom"*/).t(),
    ...
    marko_componentType = marko_registerComponent("/app$1.0.0/components/5testInput/index.marko", function() {
      return module.exports;
    }),
    marko_component = require('/app$1.0.0/components/5testInput/component'/*"./component"*/),
...
$_mod.def("/app$1.0.0/components/5testInput/index.marko.register", function(require, exports, module, __filename, __dirname) { require('/marko$4.18.24/components-browser.marko'/*'marko/components'*/).register(
                                "/app$1.0.0/components/5testInput/index.marko",
                                require('/app$1.0.0/components/5testInput/index.marko'/*"./"*/)
                            );
});
$_mod.run("/app$1.0.0/components/5testInput/index.marko.register");
$_mod.def("/app$1.0.0/html.marko.init", function(require, exports, module, __filename, __dirname) { window.$initComponents && window.$initComponents()
});
$_mod.run("/app$1.0.0/html.marko.init");
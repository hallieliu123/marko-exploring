...
$_mod.def("/app$1.0.0/components/4lifecycle/component-browser", function(require, exports, module, __filename, __dirname) { module.exports = class {
    onMount() {
        console.log('onMount');
    }
    onUpdate() {
...
$_mod.def("/app$1.0.0/components/4lifecycle/index.marko.register", function(require, exports, module, __filename, __dirname) { require('/marko$4.18.24/components-browser.marko'/*'marko/components'*/).register(
                                "/app$1.0.0/components/4lifecycle/component-browser",
                                require('/app$1.0.0/components/4lifecycle/component-browser'/*"./component-browser"*/)
                            );
});
$_mod.run("/app$1.0.0/components/4lifecycle/index.marko.register");

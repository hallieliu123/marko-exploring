...
$_mod.def("/app$1.0.0/components/myContainer.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.18.24 - DO NOT EDIT
"use strict";
...
var marko_template = module.exports = require('/marko$4.18.24/src/vdom'/*"marko/src/vdom"*/).t(),
    ...
    marko_componentType = marko_registerComponent("/app$1.0.0/components/myContainer.marko", function() {
      return module.exports;
    }),
    ...
    marko_const_nextId = marko_const("3a7b0e"),
    marko_node0 = marko_createElement("h3", null, "1", null, 1, 0, {
...
$_mod.def("/app$1.0.0/components/slot.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.18.24 - DO NOT EDIT
"use strict";

var marko_template = module.exports = require('/marko$4.18.24/src/vdom'/*"marko/src/vdom"*/).t(),
    components_helpers = require('/marko$4.18.24/src/runtime/components/helpers-browser'/*"marko/src/runtime/components/helpers"*/),
    marko_registerComponent = components_helpers.rc,
    marko_componentType = marko_registerComponent("/app$1.0.0/components/slot.marko", function() {
      return module.exports;
    }),
    marko_component = require('/app$1.0.0/components/slot.marko'/*"./slot.marko"*/),
    marko_renderer = components_helpers.r,
    marko_defineComponent = components_helpers.c,
    myContainer_template = require('/app$1.0.0/components/myContainer.marko'/*"./myContainer.marko"*/),
    marko_helpers = require('/marko$4.18.24/src/runtime/vdom/helpers'/*"marko/src/runtime/vdom/helpers"*/),
    marko_loadTag = marko_helpers.t,
    myContainer_tag = marko_loadTag(myContainer_template),
    marko_createElement = marko_helpers.e,
    marko_const = marko_helpers.const,
    marko_const_nextId = marko_const("bf5e74"),
    marko_node0 = marko_createElement("p", null, "2", null, 1, 0, {
        i: marko_const_nextId()
      })
      .t("我是被插入的组件,我有很强的灵活性。");
...
function render(input, out, __component, component, state) {
  ...
  myContainer_tag({
      renderBody: function(out, {commonData}) {
        out.e("h2", null, "1", component, 2)
          .t("我是被插入的组件,父组件传入的值 - ")
          .t(input.name);

        out.n(marko_node0, component);

        out.e("p", null, "3", component, 2)
          .t("我是被插入的组件，我是 ")
          .t(commonData);
      }
    }, out, __component, "0");
...
$_mod.def("/app$1.0.0/components/slot.marko.register", function(require, exports, module, __filename, __dirname) { require('/marko$4.18.24/components-browser.marko'/*'marko/components'*/).register(
                                "/app$1.0.0/components/slot.marko",
                                require('/app$1.0.0/components/slot.marko'/*"./slot.marko"*/)
                            );
});
$_mod.run("/app$1.0.0/components/slot.marko.register");

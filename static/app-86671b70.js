...
$_mod.installed("app$1.0.0", "marko", "4.18.24");
$_mod.remap("/marko$4.18.24/components", "/marko$4.18.24/components-browser.marko");
$_mod.main("/marko$4.18.24/src/runtime/components", "");
$_mod.remap("/marko$4.18.24/src/runtime/components/index", "/marko$4.18.24/src/runtime/components/index-browser");
$_mod.remap("/marko$4.18.24/src/runtime/components/util", "/marko$4.18.24/src/runtime/components/util-browser");
$_mod.def("/marko$4.18.24/src/runtime/components/dom-data", function(require, exports, module, __filename, __dirname) { var counter = 0;
...
$_mod.def("/marko$4.18.24/src/runtime/components/util-browser", function(require, exports, module, __filename, __dirname) { var domData = require('/marko$4.18.24/src/runtime/components/dom-data'/*"./dom-data"*/);
...
$_mod.remap("/marko$4.18.24/src/runtime/components/init-components", "/marko$4.18.24/src/runtime/components/init-components-browser");
$_mod.installed("marko$4.18.24", "warp10", "2.0.1");
...
$_mod.def("/marko$4.18.24/src/runtime/components/event-delegation", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.18.24/src/runtime/components/util-browser'/*"./util"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/morphdom/helpers", function(require, exports, module, __filename, __dirname) { function insertBefore(node, referenceNode, parentNode) {
    if (node.insertInto) {
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/morphdom/fragment", function(require, exports, module, __filename, __dirname) { var helpers = require('/marko$4.18.24/src/runtime/vdom/morphdom/helpers'/*"./helpers"*/);
...
$_mod.installed("marko$4.18.24", "complain", "1.6.0");
...
$_mod.installed("marko$4.18.24", "raptor-util", "3.2.0");
...
$_mod.def("/marko$4.18.24/src/runtime/components/KeySequence", function(require, exports, module, __filename, __dirname) { function KeySequence() {
    this.___lookup = {};
}
...
$_mod.def("/marko$4.18.24/src/runtime/components/ComponentDef", function(require, exports, module, __filename, __dirname) { "use strict";
var complain = "MARKO_DEBUG" && require('/complain$1.6.0/index'/*"complain"*/);
var componentUtil = require('/marko$4.18.24/src/runtime/components/util-browser'/*"./util"*/);
var attachBubblingEvent = componentUtil.___attachBubblingEvent;
var addDelegatedEventHandler = require('/marko$4.18.24/src/runtime/components/event-delegation'/*"./event-delegation"*/)
    .___addDelegatedEventHandler;
var extend = require('/raptor-util$3.2.0/extend'/*"raptor-util/extend"*/);
var KeySequence = require('/marko$4.18.24/src/runtime/components/KeySequence'/*"./KeySequence"*/);
...
$_mod.remap("/marko$4.18.24/src/runtime/components/registry", "/marko$4.18.24/src/runtime/components/registry-browser");
$_mod.def("/marko$4.18.24/src/runtime/components/State", function(require, exports, module, __filename, __dirname) { var extend = require('/raptor-util$3.2.0/extend'/*"raptor-util/extend"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/dom-insert", function(require, exports, module, __filename, __dirname) { var extend = require('/raptor-util$3.2.0/extend'/*"raptor-util/extend"*/);
var componentsUtil = require('/marko$4.18.24/src/runtime/components/util-browser'/*"./components/util"*/);
var destroyComponentForNode = componentsUtil.___destroyComponentForNode;
var destroyNodeRecursive = componentsUtil.___destroyNodeRecursive;
var helpers = require('/marko$4.18.24/src/runtime/vdom/morphdom/helpers'/*"./vdom/morphdom/helpers"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/createOut", function(require, exports, module, __filename, __dirname) { var actualCreateOut;
...
$_mod.def("/marko$4.18.24/src/runtime/components/GlobalComponentsContext", function(require, exports, module, __filename, __dirname) { var nextComponentIdProvider = require('/marko$4.18.24/src/runtime/components/util-browser'/*"./util"*/).___nextComponentIdProvider;
var KeySequence = require('/marko$4.18.24/src/runtime/components/KeySequence'/*"./KeySequence"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/components/ComponentsContext", function(require, exports, module, __filename, __dirname) { "use strict";
var GlobalComponentsContext = require('/marko$4.18.24/src/runtime/components/GlobalComponentsContext'/*"./GlobalComponentsContext"*/);
...
$_mod.installed("marko$4.18.24", "events-light", "1.0.5");
...
$_mod.def("/marko$4.18.24/src/runtime/RenderResult", function(require, exports, module, __filename, __dirname) { var domInsert = require('/marko$4.18.24/src/runtime/dom-insert'/*"./dom-insert"*/);
var complain = "MARKO_DEBUG" && require('/complain$1.6.0/index'/*"complain"*/);
...
$_mod.installed("marko$4.18.24", "listener-tracker", "2.0.0");
...
$_mod.remap("/marko$4.18.24/src/runtime/nextTick", "/marko$4.18.24/src/runtime/nextTick-browser");
$_mod.def("/marko$4.18.24/src/runtime/nextTick-browser", function(require, exports, module, __filename, __dirname) { /* globals window */
...
$_mod.def("/marko$4.18.24/src/runtime/components/update-manager", function(require, exports, module, __filename, __dirname) { "use strict";

var updatesScheduled = false;
var batchStack = []; // A stack of batched updates
var unbatchedQueue = []; // Used for scheduled batched updates

var nextTick = require('/marko$4.18.24/src/runtime/nextTick-browser'/*"../nextTick"*/);
...
$_mod.main("/marko$4.18.24/src/runtime/vdom/morphdom", "");
$_mod.def("/marko$4.18.24/src/runtime/vdom/morphdom/specialElHandlers", function(require, exports, module, __filename, __dirname) { function syncBooleanAttrProp(fromEl, toEl, name) {
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/VNode", function(require, exports, module, __filename, __dirname) { /* jshint newcap:false */
function VNode() {}
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/VComment", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.18.24/src/runtime/vdom/VNode'/*"./VNode"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/VDocumentFragment", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.18.24/src/runtime/vdom/VNode'/*"./VNode"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
var extend = require('/raptor-util$3.2.0/extend'/*"raptor-util/extend"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/VElement", function(require, exports, module, __filename, __dirname) { /* jshint newcap:false */
var domData = require('/marko$4.18.24/src/runtime/components/dom-data'/*"../components/dom-data"*/);
var vElementByDOMNode = domData.___vElementByDOMNode;
var VNode = require('/marko$4.18.24/src/runtime/vdom/VNode'/*"./VNode"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/VText", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.18.24/src/runtime/vdom/VNode'/*"./VNode"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/VComponent", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.18.24/src/runtime/vdom/VNode'/*"./VNode"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/VFragment", function(require, exports, module, __filename, __dirname) { var domData = require('/marko$4.18.24/src/runtime/components/dom-data'/*"../components/dom-data"*/);
var keysByDOMNode = domData.___keyByDOMNode;
var vElementByDOMNode = domData.___vElementByDOMNode;
var VNode = require('/marko$4.18.24/src/runtime/vdom/VNode'/*"./VNode"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
var createFragmentNode = require('/marko$4.18.24/src/runtime/vdom/morphdom/fragment'/*"./morphdom/fragment"*/).___createFragmentNode;
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/vdom", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.18.24/src/runtime/vdom/VNode'/*"./VNode"*/);
var VComment = require('/marko$4.18.24/src/runtime/vdom/VComment'/*"./VComment"*/);
var VDocumentFragment = require('/marko$4.18.24/src/runtime/vdom/VDocumentFragment'/*"./VDocumentFragment"*/);
var VElement = require('/marko$4.18.24/src/runtime/vdom/VElement'/*"./VElement"*/);
var VText = require('/marko$4.18.24/src/runtime/vdom/VText'/*"./VText"*/);
var VComponent = require('/marko$4.18.24/src/runtime/vdom/VComponent'/*"./VComponent"*/);
var VFragment = require('/marko$4.18.24/src/runtime/vdom/VFragment'/*"./VFragment"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/morphdom/index", function(require, exports, module, __filename, __dirname) { "use strict";
var specialElHandlers = require('/marko$4.18.24/src/runtime/vdom/morphdom/specialElHandlers'/*"./specialElHandlers"*/);
var componentsUtil = require('/marko$4.18.24/src/runtime/components/util-browser'/*"../../components/util"*/);
...
var VElement = require('/marko$4.18.24/src/runtime/vdom/vdom'/*"../vdom"*/).___VElement;
var virtualizeElement = VElement.___virtualize;
var morphAttrs = VElement.___morphAttrs;
var eventDelegation = require('/marko$4.18.24/src/runtime/components/event-delegation'/*"../../components/event-delegation"*/);
var fragment = require('/marko$4.18.24/src/runtime/vdom/morphdom/fragment'/*"./fragment"*/);
var helpers = require('/marko$4.18.24/src/runtime/vdom/morphdom/helpers'/*"./helpers"*/);
var domData = require('/marko$4.18.24/src/runtime/components/dom-data'/*"../../components/dom-data"*/);
var keysByDOMNode = domData.___keyByDOMNode;
...
$_mod.def("/marko$4.18.24/src/runtime/components/Component", function(require, exports, module, __filename, __dirname) { "use strict";
/* jshint newcap:false */

var complain = "MARKO_DEBUG" && require('/complain$1.6.0/index'/*"complain"*/);

var domInsert = require('/marko$4.18.24/src/runtime/dom-insert'/*"../dom-insert"*/);
var defaultCreateOut = require('/marko$4.18.24/src/runtime/createOut'/*"../createOut"*/);
var getComponentsContext = require('/marko$4.18.24/src/runtime/components/ComponentsContext'/*"./ComponentsContext"*/)
    .___getComponentsContext;
var componentsUtil = require('/marko$4.18.24/src/runtime/components/util-browser'/*"./util"*/);
var componentLookup = componentsUtil.___componentLookup;
...
var RenderResult = require('/marko$4.18.24/src/runtime/RenderResult'/*"../RenderResult"*/);
var SubscriptionTracker = require('/listener-tracker$2.0.0/lib/listener-tracker'/*"listener-tracker"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
var updateManager = require('/marko$4.18.24/src/runtime/components/update-manager'/*"./update-manager"*/);
var morphdom = require('/marko$4.18.24/src/runtime/vdom/morphdom/index'/*"../vdom/morphdom"*/);
var eventDelegation = require('/marko$4.18.24/src/runtime/components/event-delegation'/*"./event-delegation"*/);
var domData = require('/marko$4.18.24/src/runtime/components/dom-data'/*"./dom-data"*/);
var componentsByDOMNode = domData.___componentByDOMNode;
...
$_mod.def("/marko$4.18.24/src/runtime/components/defineComponent", function(require, exports, module, __filename, __dirname) { "use strict";
/* jshint newcap:false */

var BaseState = require('/marko$4.18.24/src/runtime/components/State'/*"./State"*/);
var BaseComponent = require('/marko$4.18.24/src/runtime/components/Component'/*"./Component"*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*"raptor-util/inherit"*/);
...
$_mod.main("/marko$4.18.24/src/loader", "");
$_mod.remap("/marko$4.18.24/src/loader/index", "/marko$4.18.24/src/loader/index-browser");
$_mod.def("/marko$4.18.24/src/loader/index-browser", function(require, exports, module, __filename, __dirname) { "use strict";
...
$_mod.def("/marko$4.18.24/src/runtime/components/registry-browser", function(require, exports, module, __filename, __dirname) { var complain = "MARKO_DEBUG" && require('/complain$1.6.0/index'/*"complain"*/);
var defineComponent = require('/marko$4.18.24/src/runtime/components/defineComponent'/*"./defineComponent"*/);
var loader = require('/marko$4.18.24/src/loader/index-browser'/*"../../loader"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/components/init-components-browser", function(require, exports, module, __filename, __dirname) { "use strict";
var warp10Finalize = require('/warp10$2.0.1/finalize'/*"warp10/finalize"*/);
var eventDelegation = require('/marko$4.18.24/src/runtime/components/event-delegation'/*"./event-delegation"*/);
var win = window;
var defaultDocument = document;
var createFragmentNode = require('/marko$4.18.24/src/runtime/vdom/morphdom/fragment'/*"../vdom/morphdom/fragment"*/)
    .___createFragmentNode;
var componentsUtil = require('/marko$4.18.24/src/runtime/components/util-browser'/*"./util"*/);
var componentLookup = componentsUtil.___componentLookup;
var addComponentRootToKeyedElements =
    componentsUtil.___addComponentRootToKeyedElements;
var ComponentDef = require('/marko$4.18.24/src/runtime/components/ComponentDef'/*"./ComponentDef"*/);
var registry = require('/marko$4.18.24/src/runtime/components/registry-browser'/*"./registry"*/);
var domData = require('/marko$4.18.24/src/runtime/components/dom-data'/*"./dom-data"*/);
var componentsByDOMNode = domData.___componentByDOMNode;
...
$_mod.def("/marko$4.18.24/src/runtime/components/index-browser", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.18.24/src/runtime/components/util-browser'/*"./util"*/);
var initComponents = require('/marko$4.18.24/src/runtime/components/init-components-browser'/*"./init-components"*/);
var registry = require('/marko$4.18.24/src/runtime/components/registry-browser'/*"./registry"*/);

require('/marko$4.18.24/src/runtime/components/ComponentsContext'/*"./ComponentsContext"*/).___initClientRendered =
...
$_mod.def("/marko$4.18.24/components-browser.marko", function(require, exports, module, __filename, __dirname) { module.exports = require('/marko$4.18.24/src/runtime/components/index-browser'/*"./src/runtime/components"*/);

});
$_mod.main("/marko$4.18.24/src/runtime/vdom", "");
$_mod.main("/marko$4.18.24/src", "");
$_mod.remap("/marko$4.18.24/src/index", "/marko$4.18.24/src/index-browser");
$_mod.def("/marko$4.18.24/src/index-browser", function(require, exports, module, __filename, __dirname) { "use strict";
exports.createOut = require('/marko$4.18.24/src/runtime/createOut'/*"./runtime/createOut"*/);
exports.load = require('/marko$4.18.24/src/loader/index-browser'/*"./loader"*/);

});
$_mod.def("/marko$4.18.24/src/runtime/vdom/helper-styleAttr", function(require, exports, module, __filename, __dirname) { var dashedNames = {};
...
$_mod.def("/marko$4.18.24/src/compiler/util/removeDashes", function(require, exports, module, __filename, __dirname) { module.exports = function removeDashes(str) {
...
$_mod.def("/marko$4.18.24/src/runtime/helpers", function(require, exports, module, __filename, __dirname) { "use strict";
var complain = "MARKO_DEBUG" && require('/complain$1.6.0/index'/*"complain"*/);
var removeDashes = require('/marko$4.18.24/src/compiler/util/removeDashes'/*"../compiler/util/removeDashes"*/);
var ComponentsContext = require('/marko$4.18.24/src/runtime/components/ComponentsContext'/*"./components/ComponentsContext"*/);
var getComponentsContext = ComponentsContext.___getComponentsContext;
var ComponentDef = require('/marko$4.18.24/src/runtime/components/ComponentDef'/*"./components/ComponentDef"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/helpers", function(require, exports, module, __filename, __dirname) { "use strict";

var vdom = require('/marko$4.18.24/src/runtime/vdom/vdom'/*"./vdom"*/);
var VElement = vdom.___VElement;
var VText = vdom.___VText;

var commonHelpers = require('/marko$4.18.24/src/runtime/helpers'/*"../helpers"*/);
var extend = require('/raptor-util$3.2.0/extend'/*"raptor-util/extend"*/);
...
var helpers = extend(
    {
        ...
        as: require('/marko$4.18.24/src/runtime/vdom/helper-attrs'/*"./helper-attrs"*/)
    },
    commonHelpers
);
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/helper-attrs", function(require, exports, module, __filename, __dirname) { var complain = "MARKO_DEBUG" && require('/complain$1.6.0/index'/*"complain"*/);
...
var styleAttr = require('/marko$4.18.24/src/runtime/vdom/helper-styleAttr'/*"./helper-styleAttr"*/);
var classAttr = require('/marko$4.18.24/src/runtime/vdom/helpers'/*"./helpers"*/).ca;
var parseContainer;
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/AsyncVDOMBuilder", function(require, exports, module, __filename, __dirname) { var EventEmitter = require('/events-light$1.0.5/src/index'/*"events-light"*/);
var vdom = require('/marko$4.18.24/src/runtime/vdom/vdom'/*"./vdom"*/);
var VElement = vdom.___VElement;
...
var morphdom = require('/marko$4.18.24/src/runtime/vdom/morphdom/index'/*"./morphdom"*/);
var attrsHelper = require('/marko$4.18.24/src/runtime/vdom/helper-attrs'/*"./helper-attrs"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/renderable", function(require, exports, module, __filename, __dirname) { var defaultCreateOut = require('/marko$4.18.24/src/runtime/createOut'/*"./createOut"*/);
var extend = require('/raptor-util$3.2.0/extend'/*"raptor-util/extend"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/vdom/index", function(require, exports, module, __filename, __dirname) { "use strict";
require('/marko$4.18.24/src/index-browser'/*"../../"*/);

// helpers provide a core set of various utility methods
// that are available in every template
var AsyncVDOMBuilder = require('/marko$4.18.24/src/runtime/vdom/AsyncVDOMBuilder'/*"./AsyncVDOMBuilder"*/);
var makeRenderable = require('/marko$4.18.24/src/runtime/renderable'/*"../renderable"*/);
...
require('/marko$4.18.24/src/runtime/createOut'/*"../createOut"*/).___setCreateOut(createOut);

});
$_mod.def("/marko$4.18.24/src/vdom", function(require, exports, module, __filename, __dirname) { module.exports = require('/marko$4.18.24/src/runtime/vdom/index'/*"./runtime/vdom"*/);

});
$_mod.remap("/marko$4.18.24/src/runtime/components/helpers", "/marko$4.18.24/src/runtime/components/helpers-browser");
$_mod.remap("/marko$4.18.24/src/runtime/components/beginComponent", "/marko$4.18.24/src/runtime/components/beginComponent-browser");
$_mod.def("/marko$4.18.24/src/runtime/components/beginComponent-browser", function(require, exports, module, __filename, __dirname) { var ComponentDef = require('/marko$4.18.24/src/runtime/components/ComponentDef'/*"./ComponentDef"*/);
...
$_mod.remap("/marko$4.18.24/src/runtime/components/endComponent", "/marko$4.18.24/src/runtime/components/endComponent-browser");
$_mod.def("/marko$4.18.24/src/runtime/components/endComponent-browser", function(require, exports, module, __filename, __dirname) { "use strict";
...
$_mod.def("/marko$4.18.24/src/runtime/components/renderer", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.18.24/src/runtime/components/util-browser'/*"./util"*/);
var componentLookup = componentsUtil.___componentLookup;
var emitLifecycleEvent = componentsUtil.___emitLifecycleEvent;

var ComponentsContext = require('/marko$4.18.24/src/runtime/components/ComponentsContext'/*"./ComponentsContext"*/);
var getComponentsContext = ComponentsContext.___getComponentsContext;
var registry = require('/marko$4.18.24/src/runtime/components/registry-browser'/*"./registry"*/);
var copyProps = require('/raptor-util$3.2.0/copyProps'/*"raptor-util/copyProps"*/);
var isServer = componentsUtil.___isServer === true;
var beginComponent = require('/marko$4.18.24/src/runtime/components/beginComponent-browser'/*"./beginComponent"*/);
var endComponent = require('/marko$4.18.24/src/runtime/components/endComponent-browser'/*"./endComponent"*/);
...
$_mod.def("/marko$4.18.24/src/runtime/components/helpers-browser", function(require, exports, module, __filename, __dirname) { require('/marko$4.18.24/src/runtime/components/index-browser'/*"./"*/);

exports.c = require('/marko$4.18.24/src/runtime/components/defineComponent'/*"./defineComponent"*/); // Referenced by compiled templates
exports.r = require('/marko$4.18.24/src/runtime/components/renderer'/*"./renderer"*/); // Referenced by compiled templates
exports.rc = require('/marko$4.18.24/src/runtime/components/registry-browser'/*"./registry"*/).___register; // Referenced by compiled templates

});
$_mod.def("/app$1.0.0/components/test.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.18.24 - DO NOT EDIT
"use strict";

var marko_template = module.exports = require('/marko$4.18.24/src/vdom'/*"marko/src/vdom"*/).t(),
    marko_component = {
    ...
    components_helpers = require('/marko$4.18.24/src/runtime/components/helpers-browser'/*"marko/src/runtime/components/helpers"*/),
    marko_registerComponent = components_helpers.rc,
    marko_componentType = marko_registerComponent("/app$1.0.0/components/test.marko", function() {
      return module.exports;
    }),
    marko_renderer = components_helpers.r,
    marko_defineComponent = components_helpers.c,
    marko_helpers = require('/marko$4.18.24/src/runtime/vdom/helpers'/*"marko/src/runtime/vdom/helpers"*/),
...
function render(input, out, __component, component, state) {
  ...
  out.be("p", null, "1", component);

  out.t("I'm counting ");

  out.h(("<b>" + input.count) + "</b>");
  ...
  marko_forEach(input.group, function(item, index) {
    ...
    out.e("button", null, "2" + $keyScope$0, component, 1, 0, {
        onclick: __component.d("click", ()=>{ component.handleClick( index + 1 ) }, false)
      })
      .t(item);
  });
...
$_mod.def("/app$1.0.0/components/hello.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.18.24 - DO NOT EDIT
"use strict";
...
var marko_template = module.exports = require('/marko$4.18.24/src/vdom'/*"marko/src/vdom"*/).t(),
    ...
    components_helpers = require('/marko$4.18.24/src/runtime/components/helpers-browser'/*"marko/src/runtime/components/helpers"*/),
    marko_registerComponent = components_helpers.rc,
    marko_componentType = marko_registerComponent("/app$1.0.0/components/hello.marko", function() {
      return module.exports;
    }),
    marko_renderer = components_helpers.r,
    marko_defineComponent = components_helpers.c,
    test_template = require('/app$1.0.0/components/test.marko'/*"./test.marko"*/),
    marko_helpers = require('/marko$4.18.24/src/runtime/vdom/helpers'/*"marko/src/runtime/vdom/helpers"*/),
...
$_mod.def("/app$1.0.0/components/hello.marko.register", function(require, exports, module, __filename, __dirname) { require('/marko$4.18.24/components-browser.marko'/*'marko/components'*/).register(
                                "/app$1.0.0/components/hello.marko",
                                require('/app$1.0.0/components/hello.marko'/*"./hello.marko"*/)
                            );
});
$_mod.run("/app$1.0.0/components/hello.marko.register");
$_mod.def("/app$1.0.0/components/test.marko.register", function(require, exports, module, __filename, __dirname) { require('/marko$4.18.24/components-browser.marko'/*'marko/components'*/).register(
                                "/app$1.0.0/components/test.marko",
                                require('/app$1.0.0/components/test.marko'/*"./test.marko"*/)
                            );
});
$_mod.run("/app$1.0.0/components/test.marko.register");
$_mod.def("/app$1.0.0/layout.marko.init", function(require, exports, module, __filename, __dirname) { window.$initComponents && window.$initComponents()
});
$_mod.run("/app$1.0.0/layout.marko.init");